...
2.1 [Смещение элементов массива - циклический сдвиг массива ](#смещение-элементов-массива---циклический-сдвиг-массива)
3. [Двумерные массивы](#двумерные-массивы)
4. [Способы выравнивания](#способы-выравнивания-лекция-6)
5. [Как обеспечить гарантия отсутсвия перекрытий (overlapping) памяти?](#как-обеспечить-гарантия-отсутсвия-перекрытий-overlapping-памяти)
6. [Умножение матриц](#умножение-матриц)
7. 
## Одномерные массивы
