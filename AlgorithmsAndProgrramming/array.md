...
### Условия вектроризации
 - Данные должны быть сполшными в памяти
 - Первый элемент каждого вестора должен быть выровнен
...
```
A (:, 1) = 0 - сплошная
A (1, :) = 0 - не сплошная, т.к. в памяти элементы хранятся по столбцам
