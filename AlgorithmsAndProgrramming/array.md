...
subroutine SortC (Y, N)
  real(:), contiguous :: Y ! непрерывный

```
## лекция 7 19.10
Размещаемые массивы являются автоматическими объектами. Управление памятью совершается автоматически.

ранг - число измерений массива

размер - число элементов
